...
<head>
    ...
    <!-- it s better to not use  REQUEST method -->
...
<body>
    ...
    if (isset($_REQUEST["submit"])) {
        // WE USE REQUEST METHOD TO CHECK USER SEND CORRECT METHOD FOR SECURITY
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (!empty($_REQUEST["firstName"]) && !empty($_POST["email"])) {
                echo "خوش آمدید" . $_REQUEST["firstName"] . "<br>";
